...
namespace Botler.Commands
{
    public class CommandFactory
    {
        ...
        {
            if (AuthCommandFound(entity))
            {
                return new AuthenticationCommand(turn, accessors);
            }

            if (ParkingCommandFound(entity))
            {
                return new ParkingCommand(turn, accessors);
            }

            if (WelcomeCommandFound(entity))
            {
                return new WelcomeCommand(turn);
            }
            ...
            if (QnACommandFound(entity))
            {
                return new QnACommand(accessors, turn);
            }

            if (QnAPublicCommandFound(entity))
            {
                return new QnAPublicCommand(accessors, turn);
            }

            if (QnARiservataCommandFound(entity))
            {
                return new QnARiservataCommand(accessors, turn);
            }

            if (LogoutCommandFound(entity))
            {
                return new LogoutCommand(turn, accessors);
            }

            if (ExitCommandFound(entity))
            {
                return new ExitCommand(turn, accessors);
            }

            if (HelpCommandFound(entity))
            {
